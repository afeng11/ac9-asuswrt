...
<body onload="initial();">
		...
		<table cellpadding="5" cellspacing="0" id="loadingBarBlock" class="loadingBarBlock" align="center">
			<tr>
				<td height="80">
					...
					<div id="loading_block2" style="margin:5px auto; width:85%;">
						<#FIRM_ok_desc#>
							<br>
	...
	<div id="hiddenMask" class="popup_bg">
		<table cellpadding="5" cellspacing="0" id="dr_sweet_advise" class="dr_sweet_advise" align="center" style="height:100px;">
			<tr>
				<td>
					<div class="drword" id="drword" style="">&nbsp;&nbsp;&nbsp;&nbsp;
						<#Main_alert_proceeding_desc4#>
							<#Main_alert_proceeding_desc1#>...
					</div>
				</td>
			</tr>
		</table>
										...
										<tr>
											<td bgcolor="#4D595D" valign="top">
												...
												<table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable">
													<thead><tr><td colspan="2"><#FW_item2#></td></tr></thead>
													<tr id="productid_tr">
														<th><#FW_item1#></th>
														<td><#Web_Title2#></td>
													</tr>
													...
													<tr id="sig_ver_field" style="display:none">
														...
														<td>
															<div style="height:33px;margin-top:5px;">
																<span id="sig_ver_word" style="color:#FFFFFF;"></span>
																<span id="sig_update_date"></span>
															</div>
													...
													<tr id="fw_version_tr">
														...
														<td>
															...
															<div id="update_div" style="margin-left:200px;margin-top:-38px;display:none;">
																<input type="button" id="update" name="update" class="button_gen" onclick="detect_update(document.start_update.firmware_path.value);"
																 value="<#liveupdate#>" />
																<span id="beta_firmware_path_span" style="display:none;">
																	<input type="checkbox" name="beta_firmware_path" id="beta_firmware_path" onclick="change_firmware_path(this.checked==true);"
																	 	<% nvram_match( "firmware_path", "1", "checked"); %> >
																		<#get_beta#>
																	</input>
																</span>
															</div>
															<div id="linkpage_div" class="button_helplink" style="margin-left:200px;margin-top:-38px;display:none;">
																<a id="linkpage" target="_blank">
												...
												<div class="amesh_manual_fw_update_hint">
													Note : Manual firmware update will update this AiMesh router / node only, if you are using AiMesh system, please make sure
													you are uploading proper firmware version.
													<!-- untranslated -->
												</div>
</td>
</tr>
	...
	<form method="post" name="firmware_form" action="/start_apply.htm" target="hidden_frame">
		...
		<table id="auto_upgrade_setting" width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable" style="display:none;">
			<thead><tr><td colspan="2">Auto Upgrade Setting</td></tr></thead>
			<tr>
				<th>Instal Newer Ofiicial Firmware Automatically</th>
				<!-- untranslated -->
				<td>
			...
			<tr>
				<th>Day To Install</th>
				<!-- untranslated -->
				<td>
					<input type="checkbox" name="upgrade_date_x_Sun" class="input" onclick="check_Timefield_checkbox();"/>
					<#date_Sun_itemdesc#>
					<input type="checkbox" name="upgrade_date_x_Mon" class="input" onclick="check_Timefield_checkbox();"/>
					<#date_Mon_itemdesc#>
					<input type="checkbox" name="upgrade_date_x_Tue" class="input" onclick="check_Timefield_checkbox();"/>
					<#date_Tue_itemdesc#>
					<input type="checkbox" name="upgrade_date_x_Wed" class="input" onclick="check_Timefield_checkbox();"/>
					<#date_Wed_itemdesc#>
					<input type="checkbox" name="upgrade_date_x_Thu" class="input" onclick="check_Timefield_checkbox();"/>
					<#date_Thu_itemdesc#>
					<input type="checkbox" name="upgrade_date_x_Fri" class="input" onclick="check_Timefield_checkbox();"/>
					<#date_Fri_itemdesc#>
					<input type="checkbox" name="upgrade_date_x_Sat" class="input" onclick="check_Timefield_checkbox();"/>
					<#date_Sat_itemdesc#>
				</td>
			</tr>
			<tr>
				...
				<!-- untranslated -->
				<td>
					<input type="text" maxlength="2" class="input_3_table" name="upgrade_time_x_hour" onKeyPress="return validator.isNumber(this,event);"
					 onblur="validator.timeRange(this, 0);" autocorrect="off" autocapitalize="off" /> :
					<input type="text" maxlength="2" class="input_3_table" name="upgrade_time_x_min" onKeyPress="return validator.isNumber(this,event);"
